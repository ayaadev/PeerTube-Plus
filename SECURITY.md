...
Currently, any version under the first major release (1.x.x) is supported.
...
You may report a vulnerability in one of two ways:
...
- You will be notified of the vulnerability being accepted.

**If the vulnerability is not accepted:**
- You will be notified of the vulnerability not being accepted, and a reason will be given as to why it was not accepted.
